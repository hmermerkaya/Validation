...
void TauValidation::analyze(const edm::Event& iEvent,const edm::EventSetup& iSetup){ 
  ...
  iEvent.getByLabel("TauSpinnerGen","TauSpinnerWT",WT);
  edm::Handle<double> WThminus;
  iEvent.getByLabel("TauSpinnerGen","TauSpinnerWThminus",WThminus);
  edm::Handle<double> WThplus;
  iEvent.getByLabel("TauSpinnerGen","TauSpinnerWThplus", WThplus);
...
void TauValidation::spinEffectsZH(const reco::GenParticle* boson, double weight){
  ...
  if(abs(boson->pdgId())==PdtPdgMini::Z0 || abs(boson->pdgId())==PdtPdgMini::Higgs0){
	...
	//	TauSpinEffectsZ_X->Fill(LVpi.P()/LVtau.E(),weight);
                    ...
                    TauSpinEffectsZ_X->Fill(LVpi.P()/LVtau.E(),weight);TauSpinEffectsZ_nospin_X->Fill(LVpi.P()/LVtau.E(),1.);TauSpinEffectsZ_Xnew->Fill(pionPt/mass_t,weight);TauSpinEffectsZ_nospin_Xnew->Fill(pionPt/mass_t,1.);
