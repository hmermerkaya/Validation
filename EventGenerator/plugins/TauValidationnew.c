...
*/
/*
TauSpinEffectsZhplus_X= i.book1D("TauSpinEffectsZX","X for pion of #tau^{-}", 25 ,0,1.0);           TauSpinEffectsZhplus_X->setAxisTitle("X");
...
TauSpinEffectsZhplus_nospin_X= i.book1D("TauSpinEffectsZnospin_X","nospin_X for pion of #tau^{-}", 25 ,0,1.0);           TauSpinEffectsZhplus_nospin_X->setAxisTitle("nospin_X");
*/
...
*/
/*
TauSpinEffectsZhplus_Xnew= i.book1D("TauSpinEffectsZXnew","Xnew for pion of #tau^{-}", 25 ,0,1.0);           TauSpinEffectsZhplus_Xnew->setAxisTitle("Xnew");
TauSpinEffectsZ_Xnew= i.book1D("TauSpinEffectsZXnew","Xnew for pion of #tau^{-}", 25 ,0,1.0);           TauSpinEffectsZ_Xnew->setAxisTitle("Xnew");
*/
/*TauSpinEffectsZ_Xnew50to75= i.book1D("TauSpinEffectsZXnew50to75","Xnew for pion of #tau^{-} (50GeV-75GeV)", 10 ,0,1.0);           TauSpinEffectsZ_Xnew->setAxisTitle("Xnew");
...
TauSpinEffectsZhplus_nospin_Xnew= i.book1D("TauSpinEffectsZnospin_Xnew","nospin_Xnew for pion of #tau^{-}", 25 ,0,1.0);           TauSpinEffectsZhplus_nospin_Xnew->setAxisTitle("nospin_Xnew");
*/
...
/*
         ...
         TauSpinEffectsZhplus_nospin_X50to75
         TauSpinEffectsZhplus_Xnew50to75
         TauSpinEffectsZhplus_nospin_Xnew50to75
       
         TauSpinEffectsZhplus_X75to88
         TauSpinEffectsZhplus_nospin_X75to88
         TauSpinEffectsZhplus_Xnew75to88
         TauSpinEffectsZhplus_nospin_Xnew75to88
       
         TauSpinEffectsZhplus_X88to100
         TauSpinEffectsZhplus_nospin_X88to100
         TauSpinEffectsZhplus_Xnew88to100
         TauSpinEffectsZhplus_nospin_Xnew88to100
         TauSpinEffectsZhplus_X100to120
         TauSpinEffectsZhplus_nospin_X100to120
         TauSpinEffectsZhplus_Xnew100to120
         TauSpinEffectsZhplus_nospin_Xnew100to120
         TauSpinEffectsZhplus_X120UP
         TauSpinEffectsZhplus_nospin_X120UP
         TauSpinEffectsZhplus_Xnew120UP
         TauSpinEffectsZhplus_nospin_Xnew120UP
...
//double jj=7;
           //         TauSpinEffectsZ_X->Fill(LVpi.P()/LVtau.E(),weight);TauSpinEffectsZ_nospin_X->Fill(LVpi.P()/LVtau.E(),1.);TauSpinEffectsZ_Xnew->Fill(pionPt/mass_t,weight);TauSpinEffectsZ_nospin_X->Fill(pionPt/mass_t,1.);
                  //  if(50.0<Zboson.M() && Zboson.M()<75.0){ TauSpinEffectsZ_X50to75->Fill(LVpi.P()/LVtau.E(),weight);TauSpinEffectsZ_nospin_X50to75->Fill(LVpi.P()/LVtau.E(),1) ;}
                   // if(75.0<Zboson.M() && Zboson.M()<88.0) {TauSpinEffectsZ_X75to88->Fill(LVpi.P()/LVtau.E(),weight);TauSpinEffectsZ_nospin_X75to88->Fill(LVpi.P()/LVtau.E(),1);}
                  //  if(88.0<Zboson.M() && Zboson.M()<100.0) {TauSpinEffectsZ_X88to100->Fill(LVpi.P()/LVtau.E(),weight);TauSpinEffectsZ_nospin_X88to100->Fill(LVpi.P()/LVtau.E(),1);}
                   // if(100.0<Zboson.M() && Zboson.M()<120.0) {TauSpinEffectsZ_X100to120->Fill(LVpi.P()/LVtau.E(),weight);TauSpinEffectsZ_nospin_X100to120->Fill(LVpi.P()/LVtau.E(),1);}
/*
                    if (weightminus==0 && weightplus>1e-3 ) {
                         ...
                         if(100.0<Zboson.M() && Zboson.M()<120.0) {
                              ...
                              TauSpinEffectsZhplus_nospin_X100to120->Fill(LVpi.P()/LVtau.E(),weight);
                              TauSpinEffectsZhplus_Xnew100to120->Fill(pionPt/mass_t,weight);
                              TauSpinEffectsZhplus_nospin_Xnew100to120->Fill(pionPt/mass_t,weight);
                         }
                         if(120.0<Zboson.M()) {
                     ...
                     if (weightplus==0 && weightminus>1e-3 ) {
                         ...
                         if(100.0<Zboson.M() && Zboson.M()<120.0) {
                              ...
                              TauSpinEffectsZhminus_nospin_X100to120->Fill(LVpi.P()/LVtau.E(),weight);
                              TauSpinEffectsZhminus_Xnew100to120->Fill(pionPt/mass_t,weight);
                              TauSpinEffectsZhminus_nospin_Xnew100to120->Fill(pionPt/mass_t,weight);
                         }
                         if(120.0<Zboson.M()) {
